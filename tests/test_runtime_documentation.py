...
EXPECTED_ACTIVE_PENDING = {
    ...
    "combo-applier::Structured combo steps applied",
    "combo-applier::Endpoint ids retained for audit",
    "combo-applier::Drift guard uses structured baseline",
    "allocator::Allocation target carries structured member identity",
    "allocator::Duplicate canonical model avoided when alternative exists",
    "allocator::Family concentration reported",
    "allocator::Quota pool remains hard gate",
